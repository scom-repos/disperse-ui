      ...
      <i-panel class="template-layout disperse-component">
        ...
        <i-panel class="container-layout">
          ...
          <i-vstack id="containerElm" position="relative" margin={{top: 50}} minHeight={800}>
            <i-hstack id="firstStepElm" class="step-elm" minHeight={200} padding={{left: 50, right: 50}} border={{ radius: 30 }} verticalAlignment="center" horizontalAlignment="space-between" background={{color: Theme.background.modal}}>
            ...
            <i-hstack id="secondStepElm" class="step-elm" minHeight={200} margin={{top: 40}} padding={{left: 50, right: 50}} border={{ radius: 30 }} verticalAlignment="center" horizontalAlignment="space-between" background={{color: Theme.background.modal}}>
            ...
            <i-vstack id="thirdStepElm" class="step-elm" minHeight={300} margin={{top: 40}} padding={{left: 50, right: 50}} border={{ radius: 30 }} verticalAlignment="center" background={{color: Theme.background.modal}}>
